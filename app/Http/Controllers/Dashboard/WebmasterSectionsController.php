...
class WebmasterSectionsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (@Auth::user()->permissionsGroup->view_status) {
            $WebmasterSections = WebmasterSection::where('created_by', '=', Auth::user()->id)->orderby('row_no', 'asc')->paginate(config('roqay.backend_pagination'));
        } else {
            $WebmasterSections = WebmasterSection::orderby('row_no', 'asc')->paginate(config('roqay.backend_pagination'));
        }
