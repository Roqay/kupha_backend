...
---------------------------------------- <br>
For more details check <a href='http://smartfordesign.net/roqay/documentation/api.html' target='_blank'><strong>API documentation</strong></a>
</div>
</body>
</html>
        ";
                                ...
                                foreach ($Topic->fields as $t_field) {
                                    if ($t_field->field_id == $customField->id) {
                                        if ($customField->type == 7) {
                                            ...
                                            $cf_details_var2 = "details_" . config('roqay.default_language');
    ...
    public function category($cat_id, $page_number = 1, $topics_count = 0, $lang = '')
    {
        if ($cat_id > 0) {
            ...
            })->whereIn('id', $category_topics)->orderby('row_no', config('roqay.frontend_topics_order'))->orderby('id', config('roqay.frontend_topics_order'));
