...
{{-- {{dd($Topic->maps)}} --}}
        ...
        <div class="container bg-white contact_us_content py-3">
            <div class="d-flex about_company mt-4 contact_margin">
                <hr class="separator">
                <span class="mx-3">اتصل بنا</span>
                <hr class="separator">
            </div>
            <h3 class="mb-5 font-weight-bold contact_margin">ابق على تواصل معنا</h3>
            <article class="mb-5">
    ...
    {{-- @include('frontEnd.'.config('theme.THEME') .'.topic.maps') --}}
    </div>
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="info">
                    @if (Helper::GeneralSiteSettings('contact_t1_' . @Helper::currentLanguage()->code) != '')
                        <div class="address">
                            ...
                            <p>{{ Helper::GeneralSiteSettings('contact_t1_' . @Helper::currentLanguage()->code) }}
                            </p>
                        </div>
                    @endif
                    @if (Helper::GeneralSiteSettings('contact_t3') != '')
                        <div class="phone">
                            ...
                            <p><span dir="ltr">{{ Helper::GeneralSiteSettings('contact_t3') }}</span></p>
                        </div>
                    @endif
                    @if (Helper::GeneralSiteSettings('contact_t5') != '')
                        <div class="phone">
                            ...
                            <p><span dir="ltr">{{ Helper::GeneralSiteSettings('contact_t5') }}</span></p>
                        </div>
                    @endif
                    @if (Helper::GeneralSiteSettings('contact_t4') != '')
                        <div class="phone">
                            ...
                            <p><span dir="ltr">{{ Helper::GeneralSiteSettings('contact_t4') }}</span></p>
                        </div>
                    @endif
                    ...
                    @if (Helper::GeneralSiteSettings('contact_t7_' . @Helper::currentLanguage()->code) != '')
                        <div class="email">
                            ...
                            <p>{{ Helper::GeneralSiteSettings('contact_t7_' . @Helper::currentLanguage()->code) }}
                            </p>
                        </div>
                    @endif
                </div>
            ...
            <div class="col-lg-8 mt-5 mt-lg-0" id="contact-form-container">
                ...
                <div>
                    <button type="submit" id="contactFormSubmit" class="btn red_button px-5 mb-2"><i
    ...
    <div>
        <iframe id="Map" title="Map" width="100%" height="300" class="mt-5"
