                    ...
                    @if(count($Topic->webmasterSection->customFields) >0)
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                $cf_title_var2 = "title_" . config('roqay.default_language');
                                ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="bottom-article newcomment">
                                                    ...
                                                    $slug_var2 = "seo_url_slug_" . config('roqay.default_language');
                                                    ?>
...
@push("after-scripts")
    ...
    @if(count($Topic->maps) >0)
        ...
        <script type="text/javascript"
                src="//maps.google.com/maps/api/js?key={{ config('roqay.google_maps_key') }}&language={{@Helper::currentLanguage()->code}}&callback=Function.prototype"></script>
