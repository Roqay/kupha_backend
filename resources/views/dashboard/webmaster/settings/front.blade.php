        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <select name="front_topics_order" id="front_topics_order"
                        class="form-control c-select">
                    <option
                        value="asc" {{ (config('roqay.frontend_topics_order') == "asc") ? "selected='selected'":""  }}>{!!  __('backend.topicsOrderInFrontAsc') !!}</option>
                    <option
                        value="desc" {{ (config('roqay.frontend_topics_order') == "desc") ? "selected='selected'":""  }}>{!!  __('backend.topicsOrderInFrontDesc') !!}</option>
                </select>
            </div>
