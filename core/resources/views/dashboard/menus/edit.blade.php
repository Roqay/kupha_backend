    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label class="ui-check ui-check-md">
                                {!! Form::radio('type','0',($Menus->type==0) ? true : false, array('id' => 'type1','class'=>'has-value','onclick'=>'document.getElementById("link_div").style.display="none";document.getElementById("cat_div").style.display="none"')) !!}
                ...
                <div id="link_div" style="{{ ($Menus->type ==1)? "":"display: none" }}">
                    @foreach(Helper::languagesList() as $ActiveLanguage)
                        @if($ActiveLanguage->box_status)
                            <div class="form-group row">
                                <label
