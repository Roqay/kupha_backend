                    ...
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a href="about.html" class="nav-link">عن الجمعية</a>
                                </li>
                                <li class="nav-item">
                                    <a href="message.html" class="nav-link">الرسالة</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="urls.html" class="nav-link">
                                        الروبط
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a href="member-ship.html" class="nav-link">
                                العضوية
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <ul>
                            <li>
                                <div class="navbar-option-item navbar-option-language dropdown language-option">
                                    <button class="dropdown-toggle" type="button" id="language1"
