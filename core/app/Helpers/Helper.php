...
class Helper
{
    ...
    static function currentLanguage()
    {
        ...
        if (empty($Language)) {
            $Language = Language::where("code", config('roqay.default_language'))->first();
        }
        return $Language;
    }
    ...
    static function languageURL($lang_code, $page_type = "", $page_id = 0)
    {
        ...
        if (@$page_type == "section" && @$page_id > 0) {
            ...
            if ($lang_code != config('roqay.default_language')) {
    ...
    static function homeURL()
    {
        ...
        if ($lang == config('roqay.default_language')) {
        ...
        try {
            ...
            if (!empty($WebmasterSection)) {
                if ($WebmasterSection->{'seo_url_slug_' . $lang} != "") {
                    ...
                    $slug = $WebmasterSection->{'seo_url_slug_' . config('roqay.default_language')};
                }
                if ($slug == "") {
        ...
        try {
            ...
            if (!empty($Category)) {
                if ($Category->{'seo_url_slug_' . $lang} != "") {
                    ...
                    $cat_slug = $Category->{'seo_url_slug_' . config('roqay.default_language')};
                }
                if ($cat_slug == "") {
                ...
                if (!empty($WebmasterSection)) {
                    if ($WebmasterSection->{'seo_url_slug_' . $lang} != "") {
                        ...
                        $WebmasterSection_slug = $WebmasterSection->{'seo_url_slug_' . config('roqay.default_language')};
                    }
                ...
                if (!empty($fatherSection2)) {
                    if ($fatherSection2->{'seo_url_slug_' . $lang} != "") {
                        ...
                        $cat2_slug = $fatherSection2->{'seo_url_slug_' . config('roqay.default_language')};
                    }
                    if ($cat2_slug == "") {
                    ...
                    if (!empty($fatherSection1)) {
                        ...
                        if ($fatherSection1->{'seo_url_slug_' . $lang} != "") {
                            ...
                            $cat1_slug = $fatherSection1->{'seo_url_slug_' . config('roqay.default_language')};
                        }
                        if ($cat1_slug == "") {
        ...
        try {
            ...
            if (!empty($Topic)) {
                if ($Topic->{'seo_url_slug_' . $lang} != "") {
                    ...
                    $topic_slug = $Topic->{'seo_url_slug_' . config('roqay.default_language')};
                }
                if ($topic_slug == "") {
    ...
    {
        if ($date != "") {
            $format = config('roqay.date_format');
    ...
    static function Topics($SectionId, $CatId = 0, $limit = 12, $random = 0)
    {
        try {
            ...
            if ($random) {
                ...
                $Topics = $Topics->orderby('date', config('roqay.frontend_topics_order'))->orderby('id', config('roqay.frontend_topics_order'));
            }
            if ($limit > 0) {
